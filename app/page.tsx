...
const ShellHeader = memo(function ShellHeader({ title, right }: { title?: string; right?: React.ReactNode }) {
  return (
    <header className="flex items-center justify-between px-8 py-4 border-b border-border shrink-0 bg-card/80 backdrop-blur-sm">
...
const CategorySidebar = memo(function CategorySidebar({
  ...
  return (
    <aside className="flex flex-col shrink-0 py-3 gap-0.5 border-r border-border overflow-y-auto bg-card/60" style={{ width: 180 }}>
      {categories.map((cat) => (
  ...
  return (
    <>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Channel list */}
        <div className="flex flex-col shrink-0 border-r border-border overflow-y-auto bg-card/40" style={{ width: 240 }}>
        ...
        {/* Day navigator */}
        <aside className="flex flex-col shrink-0 border-l border-border py-4 gap-1 overflow-y-auto bg-card/60" style={{ width: 72 }}>
          {DAYS.map((d, i) => (
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 min-w-0 p-3 pl-0">
        <div className="flex flex-col flex-1 rounded-2xl overflow-hidden border border-border bg-background/95 backdrop-blur-sm shadow-xl relative">
          {TABS.map((tab) => (
